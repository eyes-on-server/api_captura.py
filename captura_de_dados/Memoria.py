...
class Memoria:
    ...
    def get_memory_usage_percent(self, momento):
        ...
        self.verificar_memoria(memory_usage_percent, momento, 1, 'DN141')
        self.verificar_memoria(memory_usage_percent_2, momento, 2, 'DV921')
        self.verificar_memoria(memory_usage_percent_3, momento, 3, 'FE091')
        self.verificar_memoria(memory_usage_percent_4, momento, 4, 'IS592')
        self.verificar_memoria(memory_usage_percent_5, momento, 5, 'OT114')
        self.verificar_memoria(memory_usage_percent_6, momento, 6, 'PA404')
